...
{ struct Entry *ln1 ;
  ...
  __repair_swap1_46__364: /* CIL Label */ 
  ln1 = ln1->previous;
  ln2 = l->head;
  while (1) {
    if ((unsigned int )ln1->previous == (unsigned int )l->head) {
      ...
      __repair_swap1_57__365: /* CIL Label */ 
      ln1 = l->head;
    }
...
{ struct List *l ;
  ...
  n2->element = (char *)"N2";
  newNode(& n3);
  __repair_swap1_70__366: /* CIL Label */ ;
  newNode(& n4);
  n4->element = (char *)"N4";
  __repair_app_103__367: /* CIL Label */ 
  {
  status = 0;
  newList(& l);
  }
  ...
  while ((unsigned int )tmp != (unsigned int )((void *)0)) {
    if ((int )*(tmp + 0) == 34) {
      ...
      __repair_del_64__368: /* CIL Label */ 
      {

      }
    }
    tmp___1 = strcmp(tmp, "N1");
    __repair_swap1_83__369: /* CIL Label */ 
    ...
    if (tmp___3 == 0) {
      ...
      __repair_swap1_112__36a: /* CIL Label */ 
      n3->element = (char *)"N3";
    }
    __repair_swap1_78__36b: /* CIL Label */ 
    if (tmp___1 == 0) {
      node = n1;
    } else {
    ...
    if (tmp___4 == 0) {
      __repair_swap1_92__36c: /* CIL Label */ ;
    } else {
  ...
  if (tmp___7 == 0) {
    ...
    __repair_del_92__36e: /* CIL Label */ 
    __repair_swap1_71__36d: /* CIL Label */ 
    {
