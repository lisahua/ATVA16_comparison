...
{ struct Entry *ln1 ;
  ...
  __repair_app_28__306: /* CIL Label */ 
  {
  exit(1);
  return (1);
  }
...
{ char *x ;
  ...
  __repair_swap1_68__307: /* CIL Label */ 
  e = e->next;
  tmp___0 = strtok(x, " ");
  tmp = (char *)tmp___0;
  newList(& l);
  newNode(& n1);
  __repair_swap1_62__308: /* CIL Label */ 
  if (tmp___3 == 0) {
    node = n3;
  } else {
  ...
  while ((unsigned int )tmp != (unsigned int )((void *)0)) {
    ...
    __repair_swap1_77__309: /* CIL Label */ 
    newNode(& n2);
    tmp___4 = strcmp(tmp, "N4");
    __repair_del_64__30b: /* CIL Label */ 
    __repair_del_64__30a: /* CIL Label */ 
    {
    ...
    e->next = node;
    __repair_swap1_72__30c: /* CIL Label */ 
    x = *(argv + 1);
