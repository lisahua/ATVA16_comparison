...
case $2 in
  ...
  p3) $1 "N1 N2 N1" | diff 4.exp - && exit 0 ;;
  p4) $1 "N1 N2 N3 N1" | diff 5.exp - && exit 0 ;;
  p5) $1 "N1 N2 N2" | diff 6.exp - && exit 0 ;;
  p6) $1 "N1 N2 N3 N3" | diff 8.exp - && exit 0 ;;
  p7) $1 "N1 N2 N3 N2" | diff 9.exp - && exit 0 ;;
  n1) $1 "N1 H" | diff 2.exp - && exit 0 ;;
  n2) $1 "N1 N2 N3 H" | diff 7.exp - && exit 0 ;;
