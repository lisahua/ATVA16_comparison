...
case $2 in
  p1) $1 "" | diff 6.exp - && exit 0 ;;
  n1) $1 "3 3" | diff 1.exp - && exit 0 ;;
  n2) $1 "0 1 1" | diff 10.exp - && exit 0 ;;
  n3) $1 "22" | diff 2.exp - && exit 0 ;;
  n4) $1 "0 -3" | diff 3.exp - && exit 0 ;;
  n5) $1 "0 0 0" | diff 4.exp - && exit 0 ;;
  n6) $1 "4 3 1 6" | diff 5.exp - && exit 0 ;;
  n7) $1 "4 0 5 3 1 8 9 -10" | diff 7.exp - && exit 0 ;;
  n8) $1 "0 0 -1" | diff 8.exp - && exit 0 ;;
  n9) $1 "0 1 0" | diff 9.exp - && exit 0 ;;
