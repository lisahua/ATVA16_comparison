...
case $2 in
  ...
  p2) $1 "5" | diff 2.exp - && exit 0 ;;
  n1) $1 "3 1 2 2" | diff 10.exp - && exit 0 ;;
  n2) $1 "1 3 2 3" | diff 11.exp - && exit 0 ;;
  n3) $1 "5 1" | diff 3.exp - && exit 0 ;;
  n4) $1 "5 7" | diff 4.exp - && exit 0 ;;
  n5) $1 "2 1 3" | diff 5.exp - && exit 0 ;;
  n6) $1 "1 2 3" | diff 6.exp - && exit 0 ;;
  n7) $1 "3 2 1" | diff 7.exp - && exit 0 ;;
  n8) $1 "3 1 2" | diff 8.exp - && exit 0 ;;
  n9) $1 "1 3 2" | diff 9.exp - && exit 0 ;;
