...
case $2 in
  ...
  p3) $1 "5 1" | diff 3.exp - && exit 0 ;;
  p4) $1 "5 7" | diff 4.exp - && exit 0 ;;
  p5) $1 "2 1 3" | diff 5.exp - && exit 0 ;;
  p6) $1 "1 2 3" | diff 6.exp - && exit 0 ;;
  p7) $1 "3 2 1" | diff 7.exp - && exit 0 ;;
  p8) $1 "3 1 2" | diff 8.exp - && exit 0 ;;
  p9) $1 "1 3 2" | diff 9.exp - && exit 0 ;;
